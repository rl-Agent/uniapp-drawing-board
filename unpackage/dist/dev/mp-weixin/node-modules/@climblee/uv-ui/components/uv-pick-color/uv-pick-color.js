...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    i: _ctx.$uv.getPx($data.site[1].left - 10, true),
    j: common_vendor.o(($event) => $options.touchstart($event, 1)),
    k: common_vendor.o(($event) => $options.touchmove($event, 1)),
    l: common_vendor.o(($event) => $options.touchend($event, 1)),
    m: common_vendor.f($data.colorList, (item, index, i0) => {
      return {
        a: `rgba(${item.r},${item.g},${item.b},${item.a})`,
        b: common_vendor.o(($event) => $options.setColorBySelect(item), index),
        c: index
      };
    }),
    n: common_vendor.sr("pickerColorPopup", "3caff093-0"),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3caff093"], ["__file", "C:/Users/chasony/code/git-code/draw_front/node_modules/@climblee/uv-ui/components/uv-pick-color/uv-pick-color.vue"]]);
